...
#Region " Opening/Saving "
    ...
    Private _cleanCommand As RelayCommand
    Public ReadOnly Property CleanCommand As RelayCommand
      Get
        If _cleanCommand Is Nothing Then
          _cleanCommand = New RelayCommand(Sub(param)
                                             CleanPack.Clean(Me.ProjectSettings, Me.SelectedPackage, Me.SelectedLocale)
                                             MessageBox.Show("Cleaned " + Me.SelectedPackage.FriendlyName, "Translator")
                                           End Sub,
                                     Function()
                                       Return CBool(Me.ProjectSettings IsNot Nothing And Me.SelectedPackage IsNot Nothing)
                                     End Function)
        End If
