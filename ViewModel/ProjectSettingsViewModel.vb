...
#Region " Setting Properties "
    ...
    Public Property DoNotUseLastModified() As Boolean
      Get
        Return _projectSettings.DoNotUseLastModified
      End Get
      Set(ByVal value As Boolean)
        _projectSettings.DoNotUseLastModified = value
        Me.OnPropertyChanged("DoNotUseLastModified")
      End Set
    End Property
