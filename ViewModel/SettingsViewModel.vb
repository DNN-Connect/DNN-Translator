...
#Region " Constructors "
  Public Sub New(appSettings As Common.TranslatorSettings, projectSettings As Common.ProjectSettings)
   _translatorSettings = appSettings
   _projectSettings = projectSettings
   SettingPanels.Add(New TranslatorSettingsViewModel(Me.TranslatorSettings))
   If _projectSettings IsNot Nothing Then
    SettingPanels.Add(New ProjectSettingsViewModel(Me.ProjectSettings))
    _selectedPanel = SettingPanels(1)
   Else
