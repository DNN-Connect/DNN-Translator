   ...
   If _controlDataCollection Is Nothing Then
    ...
    If _nestingDepth <= ViewModelData.MenuItemNestingCount Then
     ...
     For i As Integer = 0 To ViewModelData.GalleryCount - 1
							Dim galleryData As New GalleryData() With { _
								Key .Label = "Gallery " & i, _
								Key .SmallImage = smallImage, _
								Key .LargeImage = largeImage, _
								Key .ToolTipTitle = "ToolTip Title", _
								Key .ToolTipDescription = "ToolTip Description", _
								Key .ToolTipImage = smallImage, _
								Key .Command = ViewModelData.DefaultCommand _
							}
